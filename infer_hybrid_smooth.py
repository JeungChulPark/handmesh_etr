...
jitter reduction is visible side-by-side. Same model path as infer_hybrid.py.

    python infer_hybrid_smooth.py --ckpt mobrecon_ckpt/hybrid_fastvit_bb_uv2d/best.pt \
