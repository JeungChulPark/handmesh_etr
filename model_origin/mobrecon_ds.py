...
import torch
from model_origin.densestack import DenseStack_Backnone
from model_origin.modules import Reg2DDecode3D
from model_origin.loss import l1_loss, normal_loss, edge_length_loss, contrastive_loss_3d, contrastive_loss_2d
from model_origin.read import spiral_tramsform
from model_origin.conv import SpiralConv
from model_origin.conv import DSConv
...
class MobRecon_DS(nn.Module):
    def __init__(self, cfg):
        ...
        working_dir = '/root/HandMesh_ETRI/' # depend on your terminal execution
        template_fp = os.path.join(working_dir, 'template/template.ply')
        transform_fp = os.path.join(working_dir, 'template', 'transform.pkl')
