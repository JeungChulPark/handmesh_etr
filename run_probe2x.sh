...
python cache_mediapipe.py --dataset dexycb --root "$DEXYCB" --stride 4 --out cache/mp_dexycb_s4.npz
echo "==== cache HO3D stride 2 (2x) ===="
python cache_mediapipe.py --dataset ho3d --root "$HO3D" --stride 2 --out cache/mp_ho3d_s2.npz
echo "==== train combined (2x data) ===="
python train_zlifter.py --exp zlifter_probe2x --datasets dexycb,ho3d \
