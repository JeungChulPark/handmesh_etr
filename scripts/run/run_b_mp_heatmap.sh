...
python scripts/train/train_mobrecon_rgbd.py --exp ft_mp_heatmap_s --datasets iphone \
...
python scripts/eval/eval_iphone.py --ckpt mobrecon_ckpt/ft_mp_heatmap_s/best.pt \
