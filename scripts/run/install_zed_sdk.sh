...
# conda env handmesh_etr / Python 3.10). The live scripts/infer/infer_rgbd_zed.py needs the
...
echo "[zed] DONE.  Now run:  bash scripts/run/run_zed_handpose.sh"
