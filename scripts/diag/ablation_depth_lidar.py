...
Same protocol as scripts/diag/ablation_depth.py, but evaluates the LiDAR-simulation-trained
...
ablation exposed -> expect C - A here to be far smaller than the rgbd_1hr collapse.
    ...
    python scripts/diag/ablation_depth_lidar.py [rgbd_ckpt] [rgb_only_ckpt]
"""
...
def main():
    ...
    cfg = load_cfg("configs/configs_rgbd.yaml")
