...
Loads a checkpoint produced by scripts/train/train_mobrecon_rgbd.py and reports root-relative
...
Run:
    python scripts/eval/eval_rgbd.py --ckpt mobrecon_ckpt/rgbd_1hr/3.pt --depth_source cache
    python scripts/eval/eval_rgbd.py --ckpt mobrecon_ckpt/rgbd_1hr/3.pt --rgb_only   # ablation
"""
