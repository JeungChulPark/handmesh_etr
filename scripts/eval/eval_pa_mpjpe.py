...
Run:
    python scripts/eval/eval_pa_mpjpe.py --ckpt mobrecon_ckpt/ds_hybrid_ft2/best.pt
    python scripts/eval/eval_pa_mpjpe.py --ckpt mobrecon_ckpt/ds_hybrid/best.pt --max_eval 5000 --device cpu
"""
