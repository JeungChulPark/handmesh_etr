...
Usage:
    python scripts/capture/make_iphone_gt.py --dir rgbd_captures                 # auto rotation
    python scripts/capture/make_iphone_gt.py --dir rgbd_captures_03 --rotate 0   # force k=0
    python scripts/capture/make_iphone_gt.py --dir rgbd_captures --no_viz        # skip QA pngs
"""
