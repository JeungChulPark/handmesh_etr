...
subj [N] (subject id, for a leakage-free train/test split).
    ...
    python scripts/capture/cache_mediapipe.py --root "$DEXYCB" --stride 8 --out cache/mp_dexycb.npz
    python scripts/capture/cache_mediapipe.py --root "$DEXYCB" --limit 30 --out /tmp/mp_test.npz   # smoke
"""
