...
Run:
  python scripts/infer/infer_rgbd_captures.py                       # dir=rgbd_captures, best.pt
  python scripts/infer/infer_rgbd_captures.py --dir rgbd_captures --rotate auto
  python scripts/infer/infer_rgbd_captures.py --rotate 90 --limit 20
"""
