...
This is the same per-frame path as `scripts/infer/infer_hybrid.py`, but the frame source is a
...
Examples
--------
  python scripts/infer/infer_zed_hybrid.py                                   # live ZED, hybrid_B
  python scripts/infer/infer_zed_hybrid.py --source svo --svo rec.svo2
  python scripts/infer/infer_zed_hybrid.py --no-gui --save zed_hybrid_out/   # headless dump
  python scripts/infer/infer_zed_hybrid.py --source selftest                 # no hardware
"""
