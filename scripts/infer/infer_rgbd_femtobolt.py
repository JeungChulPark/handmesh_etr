...
This is the *deployment* counterpart of `scripts/train/train_mobrecon_rgbd.py` / `scripts/eval/eval_rgbd.py`:
...
`scripts/train/train_mobrecon_rgbd.py` runs here without any conversion. The only difference
...
# ===========================================================================
class RGBDHandPose:
    def __init__(self, ckpt, cfg_path="./configs/configs_rgbd.yaml", device=None,
