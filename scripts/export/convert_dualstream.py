...
Run:
    python scripts/export/convert_dualstream.py --ckpt mobrecon_ckpt/ds_anchor_gate/best.pt
"""
...
def main(args):
    ...
    try:
        ...
        print("[coreml] coremltools not installed -> ONNX only. "
              "Convert on a Mac: pip install coremltools && python scripts/export/convert_dualstream.py ...")
    except Exception as e:
