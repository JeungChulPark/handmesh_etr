...
namespace HandMesh.HandGrab
{
    ...
    /// <summary>Vector3 1€ filter — one scalar filter per axis.</summary>
    public sealed class OneEuroFilterV3
    {
        ...
        public OneEuroFilterV3(float minCutoff = 1.0f, float beta = 0.02f)
        {
